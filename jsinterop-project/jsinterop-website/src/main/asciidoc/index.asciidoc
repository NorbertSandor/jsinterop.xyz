...
<div class="toggler"><input id="generatedJavascriptCodeField" type="checkbox" /> Show generated Javascript in code examples</div>
<div class="toggler"><input id="javaSourceCodeField" type="checkbox" checked /> Show Java source in code examples</div>
<div class="toggler"><input id="xtendSourceCodeField" type="checkbox" checked /> Show Xtend source in code examples</div>
...
document.getElementById("generatedJavascriptCodeField").addEventListener("click", function() {
	updateBlocks("generatedJavascriptCode");
});
document.getElementById("javaSourceCodeField").addEventListener("click", function() {
	updateBlocks("javaSourceCode");
	getBlockField("xtendSourceCode").disabled = !isBlockVisible("javaSourceCode");
});
document.getElementById("xtendSourceCodeField").addEventListener("click", function() {
...
_JsInterop.xyz_ is in early-access phase, it is not feature-complete yet and is not recommended for production.
...
The Javascript global scope (the `window`) and the can be accessed by the static method `JsGlobals.getWindow()`:
...
.Java code
----
include::../../../../jsinterop-test/src/main/java/xyz/jsinterop/test/client/docs/Primitives.java[tags=primitiveSemantics_boolean]
----

[source,javascript,indent=0,role="generatedJavascriptCode"]
.Generated Javascript code
----
include::../../../../jsinterop-test/target/gwt-asciidoc/gwt.js[tags=primitiveSemantics_boolean]
----
...
.Java code
----
include::../../../../jsinterop-test/src/main/java/xyz/jsinterop/test/client/docs/Primitives.java[tags=primitiveSemantics_others]
----

[source,javascript,indent=0,role="generatedJavascriptCode"]
.Generated Javascript code
----
include::../../../../jsinterop-test/target/gwt-asciidoc/gwt.js[tags=primitiveSemantics_others]
----
...
.Java code
----
include::../../../../jsinterop-test/src/main/java/xyz/jsinterop/test/client/docs/Primitives.java[tags=primitiveSemantics_double]
----

[source,javascript,indent=0,role="generatedJavascriptCode"]
.Generated Javascript code
----
include::../../../../jsinterop-test/target/gwt-asciidoc/gwt.js[tags=primitiveSemantics_double]
----
...
.Java code
----
include::../../../../jsinterop-test/src/main/java/xyz/jsinterop/test/client/docs/Primitives.java[tags=primitiveSemantics_float]
----

[source,javascript,indent=0,role="generatedJavascriptCode"]
.Generated Javascript code
----
include::../../../../jsinterop-test/target/gwt-asciidoc/gwt.js[tags=primitiveSemantics_float]
----
...
.Java code
----
include::../../../../jsinterop-test/src/main/java/xyz/jsinterop/test/client/docs/Primitives.java[tags=primitiveSemantics_long]
----

[source,javascript,indent=0,role="generatedJavascriptCode"]
.Generated Javascript code
----
include::../../../../jsinterop-test/target/gwt-asciidoc/gwt.js[tags=primitiveSemantics_long]
----
...
* In JsInterop interfaces
** the most "safe" primitive types are `int` and `double`,
