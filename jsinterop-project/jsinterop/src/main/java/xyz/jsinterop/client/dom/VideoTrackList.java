...
public interface VideoTrackList extends EventTarget {
	...
	@JsOverlay
	public default VideoTrack get(final int index) {
		return (VideoTrack) xyz.jsinterop.client.core.JsArrays.getArrayItem(this, index);
	}

	@JsOverlay
	public default void set(final int index, final VideoTrack value) {
		xyz.jsinterop.client.core.JsArrays.setArrayItem(this, index, value);
	}

	@JsMethod
	public abstract VideoTrack getTrackById(final String id);

	@JsMethod
	public abstract VideoTrack item(final double index);
