...
public interface SVGMaskElement
		extends SVGElement, SVGStylable, SVGTests, SVGLangSpace, SVGExternalResourcesRequired, SVGUnitTypes {
	@JsProperty
	...
	@JsProperty
	public abstract void setMaskContentUnits(final SVGAnimatedEnumeration value);

	@JsProperty
	public abstract SVGAnimatedEnumeration getMaskUnits();

	@JsProperty
	public abstract void setMaskUnits(final SVGAnimatedEnumeration value);
