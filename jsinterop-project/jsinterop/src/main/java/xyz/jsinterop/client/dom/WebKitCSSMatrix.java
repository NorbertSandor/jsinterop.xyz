...
public interface WebKitCSSMatrix {
	...
	@JsMethod
	public abstract WebKitCSSMatrix inverse();

	@JsMethod
	public abstract WebKitCSSMatrix multiply(final WebKitCSSMatrix secondMatrix);

	@JsMethod
	public abstract WebKitCSSMatrix rotate(final double angleX);

	@JsMethod
	public abstract WebKitCSSMatrix rotate(final double angleX, final double angleY);

	@JsMethod
	public abstract WebKitCSSMatrix rotate(final double angleX, final double angleY, final double angleZ);

	@JsMethod
	public abstract WebKitCSSMatrix rotateAxisAngle(final double x, final double y, final double z, final double angle);

	@JsMethod
	public abstract WebKitCSSMatrix scale(final double scaleX);

	@JsMethod
	public abstract WebKitCSSMatrix scale(final double scaleX, final double scaleY);

	@JsMethod
	public abstract WebKitCSSMatrix scale(final double scaleX, final double scaleY, final double scaleZ);

	@JsMethod
	public abstract void setMatrixValue(final String value);

	@JsMethod
	public abstract WebKitCSSMatrix skewX(final double angle);

	@JsMethod
	public abstract WebKitCSSMatrix skewY(final double angle);

	@JsMethod
	public abstract String toString();

	@JsMethod
	public abstract WebKitCSSMatrix translate(final double x, final double y);

	@JsMethod
	public abstract WebKitCSSMatrix translate(final double x, final double y, final double z);
}
