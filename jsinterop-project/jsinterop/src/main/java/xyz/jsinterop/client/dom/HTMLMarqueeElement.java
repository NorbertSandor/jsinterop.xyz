...
public interface HTMLMarqueeElement extends HTMLElement {
	...
	@JsOverlay
	public default void addEventListenerBounce(final EventListener<Event> listener) {
		addEventListener("bounce", listener);
	}

	@JsOverlay
	public default void addEventListenerBounce(final EventListener<Event> listener, final boolean useCapture) {
		addEventListener("bounce", listener, useCapture);
	}
	...
	@JsOverlay
	public default void addEventListenerStart(final EventListener<Event> listener) {
		addEventListener("start", listener);
	}

	@JsOverlay
	public default void addEventListenerStart(final EventListener<Event> listener, final boolean useCapture) {
		addEventListener("start", listener, useCapture);
	}
